...
import com.zerototen.savegame.member.domain.controller.dto.MemberDto.SaveDto;
...
public class MemberController {
  ...
  public ResponseEntity<MemberDto.LoginDto> login(
      @RequestBody MemberDto.LoginDto request
  ) {
  ...
  // 회원가입
  @PostMapping("sign-up")
  public ResponseEntity<SaveDto> register(
      @RequestBody MemberDto.SaveDto request) {
