...
public class MemberService {
  ...
  public ResponseEntity<MemberDto.SaveDto> register(MemberDto.SaveDto request){
    ...
    return new ResponseEntity<>(MemberDto.SaveDto.response(member, accessToken, refreshToken), HttpStatus.OK);
  }
  ...
  public ResponseEntity<MemberDto.LoginDto> login(MemberDto.LoginDto request) {
    ...
    return new ResponseEntity<>(MemberDto.LoginDto.response(accessToken, refreshToken), HttpStatus.OK);
  }
